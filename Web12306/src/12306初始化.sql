...
(
  ...
  content 	VARCHAR(100) COMMENT '证件类型',
	PRIMARY KEY (id)
...
(
  id 				INT NOT NULL AUTO_INCREMENT,
  cityid 		VARCHAR(6) COMMENT '市标志',
  city   		VARCHAR(50) COMMENT '市名称',
  father 		VARCHAR(6) COMMENT '省份标识',
	PRIMARY KEY (id)
)ENGINE=INNODB DEFAULT CHARSET=utf8;
...
(
  ...
  provinceid 	VARCHAR(6) COMMENT '省份标识',
  province   	VARCHAR(40) COMMENT '省份名称',
	PRIMARY KEY (id)
)ENGINE=INNODB DEFAULT CHARSET=utf8;
...
(
  id 				INT(11) NOT NULL AUTO_INCREMENT,
  content 	VARCHAR(40) NOT NULL COMMENT '旅客类型',
	PRIMARY KEY (id)
)ENGINE=INNODB DEFAULT CHARSET=utf8;
...
(
  ...
  rule       VARCHAR(2) default '2' NOT NULL COMMENT '权限(1、管理员 2、普通用户)',
  realname   VARCHAR(50) NOT NULL COMMENT '真实姓名',
  sex        CHAR(1) default '1' NOT NULL COMMENT '性别(1、男 2、女)',
  city       INT(11) NOT NULL COMMENT '市信息字典ID值',
  cert_type  INT(11) NOT NULL COMMENT '证件类型字典ID值',
  cert       VARCHAR(50) NOT NULL COMMENT '证件号码',
  birthday   VARCHAR(50) NOT NULL COMMENT '生日',
  user_type  INT(11) COMMENT '旅客类型字典ID值',
  content    VARCHAR(3000) COMMENT '备注信息',
  status     CHAR(1) default '1' NOT NULL COMMENT '用户状态（0、无效  1、有效 ）',
  login_ip   VARCHAR(50) COMMENT '登陆IP',
  image_path VARCHAR(200) COMMENT '用户头像路径',
	PRIMARY KEY (id)
)ENGINE=INNODB DEFAULT CHARSET=utf8;
